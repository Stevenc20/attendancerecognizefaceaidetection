...
export default function AdminFaceEnrollment({ hasEnrolled, student }: FaceEnrollmentProps) {
    ...
    return (
        <DashboardLayout role="admin" userName={auth.user.name}>
            <Head title={`Enroll Face - ${student.name} — SMKN 40`} />
            ...
            <header className="mb-8">
                ...
                <p className="text-[14px] text-[#6B6F76] font-medium mt-1">
                    Please ensure the student is in a well-lit area before scanning.
                </p>
            </header>
